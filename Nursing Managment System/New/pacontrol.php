...
$message="";   
    ...
    $iner=$connection->insert($con,"paregistration", $_POST["fname"],$_POST["lname"], $_POST['contact'],$_POST['nid'],$_POST['email'], $_POST['password'], $_POST['gender'],
   $_POST['Address']);
    if($iner==true)
    {
    ...
    $existingdata = file_get_contents('../json/painfo.json');
        ...
        if(file_put_contents("../json/painfo.json", $jsondata)){
            ...
            header("Location:../view/paregistration.php");
        } else{

	...
	<table class="table table-striped">
		...
		<tbody>
			...
			if($order["status"]=="order"){
					...
					echo '<td><a href="AcceptOrder.php?id='.$order["order id"].'" class="btn btn-success">Accept</a></td>';
					echo '<td><a href="DeleteOrder.php?id='.$order["order id"].'" class="btn btn-danger">Delete</a></td>';

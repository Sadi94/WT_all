			...
			foreach($products as $product)
			{
				if(!empty($product["discount"])){
				   echo "<tbody>";
				    ...
				    echo '<td><a href="editDiscount.php?id='.$product["product id"].'" class="btn btn-success">Edit</a></td>';
					echo '<td><a href="removeDiscount.php?id='.$product["product id"].'" class="btn btn-danger">Remove</a></td>';

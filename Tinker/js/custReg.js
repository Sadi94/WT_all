...
<head>
	...
	<link rel="stylesheet" href="../css/custR.css">
</head>
<body>
...
<script type="text/javascript" src="../js/custReg.js"></script>
	<form id="form" action="../include/custRC.php" onsubmit="validation()" method="post">
<table>
            <tr>
					<td>First Name :</td>

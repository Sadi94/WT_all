...
<head>
	...
	<link rel="stylesheet" href="../css/stOwnR.css">
</head>
<body>
...
<script type="text/javascript" src="../js/storeOwnReg.js"></script>
	<form id="form" action="../include/storeOwnRC.php" onsubmit="validation()" method="post">
<table>
            <tr>
					<td>First Name :</td>
